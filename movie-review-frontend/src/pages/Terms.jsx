        ...
        <div style={{ padding: '8rem 15% 6rem', color: 'var(--text-main)', minHeight: '80vh' }}>
            ...
            <div style={{ backgroundColor: 'var(--bg-surface)', padding: '3rem', borderRadius: '24px', border: '1px solid rgba(139, 90, 43, 0.1)' }}>
                <div style={{ marginBottom: '2.5rem' }}>
                    ...
                    <p style={{ color: 'var(--text-dim)', lineHeight: '1.7' }}>By accessing and using FilmCritic, you agree to comply with and be bound by these terms. If you do not agree, please refrain from using the platform.</p>
                </div>
                ...
                <div style={{ marginBottom: '2.5rem' }}>
                    ...
                    <p style={{ color: 'var(--text-dim)', lineHeight: '1.7' }}>FilmCritic provides reviews for informational purposes. we are not liable for any decisions made based on the content provided on our platform.</p>
                </div>
            </div>
        </div>
    );
